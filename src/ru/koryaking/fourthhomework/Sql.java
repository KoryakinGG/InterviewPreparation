...
//                     t.price_fld as price
//        from   film_tbl as x join session_tbl as y using (film_id) join ticket_price_tbl as t using (price_id)
//               ) M
...
//  SELECT
//        a.start_time_film_fld as "Время",
//        sum(a.price * visitors) as "Кассовые сборы",
//        sum(a.visitors) as "Посетители"
//             from (
//                 select m.tickets_sold_fld as visitors,
//                        t.price_fld as price,
//                          case
//                              when m.start_time_film_fld BETWEEN '2021-02-14 07:59:59' and '2021-02-14 14:59:59'
//                                                                                              then 'с  08 по 15'
//                              when m.start_time_film_fld BETWEEN '2021-02-14 15:00:00' and '2021-02-14 17:59:59'
//                                                                                              then 'с 15 по 18'
//                              when m.start_time_film_fld BETWEEN '2021-02-14 18:00:00' and '2021-02-14 20:59:59'
//                                                                                              then 'с 18 по 21'
//                              when m.start_time_film_fld BETWEEN '2021-02-14 21:00:00' and '2021-02-14 00:00:00'
//                                                                                              then 'с 21 по 24'
//                              END start_time_film_fld
//        from session_tbl as m join ticket_price_tbl as t using (price_id)
//              group by (start_time_film_fld, visitors, price)
//                  ) a
//        group by (a.start_time_film_fld)
//        order by "Время"